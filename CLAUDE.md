...
> **Mirrors `AGENTS.md`.** Both files must be kept in sync. When updating rules, edit both.
...
Full migration how-tos and reference schemas: `00_System/Docs/` (in progress)
